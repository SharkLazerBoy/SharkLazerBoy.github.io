...
var marker1 = L.circle(londonBridge,{color: "black", fillColor: "408f55", radius:200}).bindPopup("<p>Hello, from the London Bridge!</p>").addTo(map);
var marker2 = L.circle(stonehedge,{color: "black", fillColor: "408f55", radius:200}).bindPopup("<p>Hello, from Stonehedge!</p>").addTo(map);
